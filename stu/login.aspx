<%@ Page Title="学生登录" Language="C#" AutoEventWireup="true" CodeFile="login.aspx.cs" Inherits="stu_login" %>
...
<body>
    <form id="form1" runat="server">
        <div class="login-box">
            ...
            <asp:TextBox ID="txtUserPass" runat="server" TextMode="Password" CssClass="input-box" Placeholder="请输入密码" />
